...
public class ElasticsearchSpringTest {
	...
	public static void write1(){
		...
		String result = factory.save(obj);
...
//		must.put("name", "title");
		...
		String result = factory.selectMatchAll(index, type,SampleEntity.class, must, should, must_not, ranges, "createtime", false, 1, 5);
		System.out.println(result);
	}
...
//		must.put("name", "title");
		...
		List<Object> range = Arrays.asList(new Object[]{start,end});
		ranges.put("begintime", range);
		String result =factory.selectPrefixMatchAll(index, type, SampleEntity.class, prefix, must, should, must_not, ranges, 1, 5);
		System.out.println(result);
	}
